...
GerenciadorColisao::GerenciadorColisao(Listas::ListaEntidade* lJ, Listas::ListaEntidade* lI, Listas::ListaEntidade* lO, std::vector<Entidades::Projetil*> *lP) :listaJogadores(lJ), listaInimigos(lI), listaObstaculos(lO)
{
