...
Plataforma::Plataforma(const Vector2f pos, const Vector2f tam, const bool g) :Obstaculo(pos, tam, VELOCIDADE_PLATAFORMA,IDs::ID::plataforma), grande(g)
{
...
void Plataforma::setGrande(const bool g)
{
    grande = g;
}
